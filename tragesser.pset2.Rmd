...
Therefore, given A and B are constant, when A is added and X is multiplied by $\beta$, $$\sigma_y = \beta \times \sigma_x$$
...
modelsummary(liner_model, coef_rename = c("pid7" = "Party Identification"))
```

This model demonstrates a non-significant relationship between party identification and favorability It implies that for each 1 positive step in the 1 to 7 scale from strong Democrat to strong Republican, there is a .456 drop in favorability, also measured on a 1 to 7 scale.
